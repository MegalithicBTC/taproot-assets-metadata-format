...
```
tapcli assets mint --type=normal --name=MyTestCoin --supply=1000000 --meta_type=json --meta_bytes="{\"acronym\": \"MTC\",\"description\": \"This is my test coin\", \"image_data\": \"data:image/jpg;base64,\"}"
```

Here is an example how to mint a "collectible" or a non-fungible asset:

```
tapcli assets mint --type=collectible --name=MyTestNft --supply=1000000 --meta_type=json --meta_bytes="{\"description\": \"This is my test NFT\", \"image_data\": \"data:image/jpg;base64,\"}"
```
